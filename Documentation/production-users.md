...
PD(Placement Driver) is the central controller in the TiDB cluster. It saves the cluster meta inforamtion, schedule the data, allocate the global unique timestamp for the distrubted transaction, etc. It embeds etcd to supply high availability and auto failover. 
